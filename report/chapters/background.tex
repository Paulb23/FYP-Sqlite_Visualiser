...
In this section I go over SQLites beginnings and where it is used. Starting back in spring of 2000. I also look at the SQLite file format in great depth, to under it inside out, and how to parse it.

\subsection{Similar programs}
\label{subsec:similar_programs}

Before i got far into the research of SQLite and it's history. i decided to take a look at what other system where available. 
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.70]{images/sqlite_arch.png}
